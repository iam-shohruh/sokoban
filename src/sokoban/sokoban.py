...
while running:
    for event in pygame.event.get():
        ...
        # (Note: Temporarily removed the previous move_player function to focus on the UI as requested, 
        # you can merge it later with Hamza's code to update current_level_data)
